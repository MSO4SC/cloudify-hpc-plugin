...
:uri-blueprint-examples-doc: https://github.com/MSO4SC/resources/blob/master/blueprint-examples/README.adoc
...
TIP: Example blueprints can be found at the {uri-blueprint-examples}[MSO4SC resources repository]. Chec {uri-blueprint-examples-doc}[the docs] for more information.
